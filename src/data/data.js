...
const socialIcons = [
  {
    ...
    url: "https://github.com/sundayonah",
  },

  {
    icon: <GrTwitter className="icon switch__color" />,
    url: "https://twitter.com/xhunkleph",
  },
  {
    icon: <GrInstagram className="icon switch__color" />,
    url: "https://www.instagram.com/onah_sunday.xhunkleph/",
  },
  {
    icon: <FiLinkedin className="icon switch__color" />,
    url: "https://www.linkedin.com/in/onah-sunday-0b783921a/",
  },
];
